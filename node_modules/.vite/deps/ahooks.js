...
var usePagination = function usePagination2(service, options) {
  ...
  var _b = options.defaultPageSize, defaultPageSize = _b === void 0 ? 10 : _b, _c = options.defaultCurrent, defaultCurrent = _c === void 0 ? 1 : _c, rest = __rest3(options, ["defaultPageSize", "defaultCurrent"]);
...
var useDynamicList = function useDynamicList2(initialList) {
  ...
  var setKey = (0, import_react36.useCallback)(function(index) {
  ...
  var insert = (0, import_react36.useCallback)(function(index, item) {
    setList(function(l) {
  ...
  var getKey = (0, import_react36.useCallback)(function(index) {
  ...
  var merge = (0, import_react36.useCallback)(function(index, items) {
    setList(function(l) {
      var temp = __spread13(l);
      items.forEach(function(_, i) {
        setKey(index + i);
      });
      temp.splice.apply(temp, __spread13([index, 0], items));
      return temp;
    });
  }, []);
  var replace = (0, import_react36.useCallback)(function(index, item) {
    setList(function(l) {
      var temp = __spread13(l);
      temp[index] = item;
      return temp;
  ...
  var remove = (0, import_react36.useCallback)(function(index) {
    setList(function(l) {
      var temp = __spread13(l);
      temp.splice(index, 1);
      try {
...
function useInterval(fn, delay, options) {
  ...
  var fnRef = useLatest_default(fn);
  var timerRef = (0, import_react46.useRef)();
...
function useLongPress(onLongPress, target, _a) {
  ...
  useEffectWithTarget_default(function() {
    ...
    var overThreshold = function overThreshold2(event) {
...
var useResetState = function useResetState2(initialState) {
  var _a = __read38((0, import_react60.useState)(initialState), 2), state = _a[0], setState = _a[1];
...
function useResponsive() {
  ...
  var _a = __read39((0, import_react61.useState)(info), 2), state = _a[0], setState = _a[1];
...
function useSafeState(initialState) {
  ...
  var _a = __read40((0, import_react63.useState)(initialState), 2), state = _a[0], setState = _a[1];
...
function useScroll(target, shouldUpdate) {
  ...
  var _a = __read41(useRafState_default(), 2), position = _a[0], setPosition = _a[1];
...
function useSelections(items, defaultSelected) {
  ...
  var _a = __read42((0, import_react64.useState)(defaultSelected), 2), selected = _a[0], setSelected = _a[1];
...
function useSet(initialValue) {
  ...
  var _a = __read43((0, import_react65.useState)(function() {
    return getInitValue();
...
var useSetState = function useSetState2(initialState) {
  var _a = __read44((0, import_react66.useState)(initialState), 2), state = _a[0], setState = _a[1];
...
function useSize(target) {
  var _a = __read45(useRafState_default(), 2), state = _a[0], setState = _a[1];
...
function useTextSelection(target) {
  var _a = __read46((0, import_react68.useState)(initState2), 2), state = _a[0], setState = _a[1];
...
function useThrottle(value, options) {
  var _a = __read48((0, import_react70.useState)(value), 2), throttled = _a[0], setThrottled = _a[1];
...
function useThrottleEffect(effect, deps, options) {
  var _a = __read49((0, import_react71.useState)({}), 2), flag = _a[0], setFlag = _a[1];
  var run = useThrottleFn_default(function() {
    setFlag({});
  }, options).run;
...
function useTimeout(fn, delay) {
  var fnRef = useLatest_default(fn);
  var timerRef = (0, import_react72.useRef)();
...
var useVirtualList = function useVirtualList2(list, options) {
  ...
  var _b = __read50((0, import_react76.useState)([]), 2), targetList = _b[0], setTargetList = _b[1];
...
function useWebSocket(socketUrl, options) {
  ...
  var unmountedRef = (0, import_react77.useRef)(false);
  var _d = __read51((0, import_react77.useState)(), 2), latestMessage = _d[0], setLatestMessage = _d[1];
  var _e = __read51((0, import_react77.useState)(ReadyState.Closed), 2), readyState = _e[0], setReadyState = _e[1];
...
var useMutationObserver = function useMutationObserver2(callback, target, options) {
  if (options === void 0) {
    options = {};
  }
